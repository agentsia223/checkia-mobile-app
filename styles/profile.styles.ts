...
export const s = StyleSheet.create({
  ...
  avatarText: { color: P.white, fontSize: 24, fontFamily: 'BarlowSemiCondensed-Bold' },
  name: { color: P.text, fontSize: 20, fontFamily: 'BarlowSemiCondensed-Bold', marginBottom: 4 },
  ...
  streakTitle: { color: P.text, fontSize: 16, fontFamily: 'BarlowSemiCondensed-Bold' },
